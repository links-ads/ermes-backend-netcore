...
namespace Ermes.Migrations
{
    ...
    [Migration("20231113091654_Communication_Message_MaxLengthRemoved")]
    partial class Communication_Message_MaxLengthRemoved
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ermes.Alerts.Alert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("AlertAreaOfInterestId")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("IsARecommendation")
                        .HasColumnType("boolean");

                    b.Property<string>("MsgTypeString")
                    ...
                    b.HasIndex("AlertAreaOfInterestId");

                    b.ToTable("alerts");
                });

            modelBuilder.Entity("Ermes.Alerts.AlertAreaOfInterest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("alert_areasofinterest");
                });

            modelBuilder.Entity("Ermes.Alerts.CapInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("CertaintyString")
                    ...
                    b.Property<string>("ResponseTypeString")
                        .HasColumnName("ResponseType")
                        .HasColumnType("text");

                    b.Property<string>("SeverityString")
            ...
            modelBuilder.Entity("Ermes.Communications.Communication", b =>
                {
                    ...
                    b.Property<string>("RestrictionString")
                        .IsRequired()
            ...
            modelBuilder.Entity("Ermes.Communications.CommunicationReceiver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CommunicationId", "OrganizationId")
                        .IsUnique();

                    b.ToTable("communication_receivers");
                });
            ...
            modelBuilder.Entity("Ermes.Gamification.Barrier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("LevelName", "RewardName")
                        .IsUnique();

                    b.ToTable("gamification_barriers");
                });
            ...
            modelBuilder.Entity("Ermes.Gamification.GamificationAudit", b =>
                {
                    ...
                    b.Property<int?>("GamificationActionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("GamificationActionId");
            ...
            modelBuilder.Entity("Ermes.Gamification.Reward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Ermes.Layers.Layer", b =>
                {
                    ...
                    b.Property<int?>("ParentDataTypeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ermes.MapRequests.MapRequest", b =>
                {
                    ...
                    b.Property<List<BoundaryCondition>>("BoundaryConditions")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<decimal>("ProbabilityRange")
            ...
            modelBuilder.Entity("Ermes.MapRequests.MapRequestLayer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<List<MapRequestLayerError>>("ErrorMessages")
                        .HasColumnType("jsonb");

                    b.Property<int>("LayerDataTypeId")
                        .HasColumnType("integer");

                    b.Property<string>("MapRequestCode")
                        .HasColumnType("character varying(10)");

                    b.Property<int>("ReceivedUpdates")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LayerDataTypeId");

                    b.HasIndex("MapRequestCode", "LayerDataTypeId")
                        .IsUnique();

                    b.ToTable("map_request_layers");
                });
            ...
            modelBuilder.Entity("Ermes.Notifications.NotificationReceived", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("notifications_received");
                });
            ...
            modelBuilder.Entity("Ermes.Operations.Operation", b =>
                {
                    ...
                    b.Property<PresidiResponse>("PresidiResponse")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Ermes.Reports.ReportValidation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("PersonId", "ReportId")
                        .IsUnique();

                    b.ToTable("report_validations");
                });
            ...
            modelBuilder.Entity("Ermes.Stations.Station", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("SensorServiceId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Ermes.Gamification.Achievement", b =>
                {
                    b.HasBaseType("Ermes.Gamification.Reward");

                    b.Property<GamificationDetail>("Detail")
                        .HasColumnType("jsonb");

                    b.Property<string>("GamificationActionCode")
                        .HasColumnType("character varying(100)");

                    b.HasIndex("GamificationActionCode");
            ...
            modelBuilder.Entity("Ermes.Gamification.Award", b =>
                {
                    b.HasBaseType("Ermes.Gamification.Reward");
            ...
            modelBuilder.Entity("Ermes.Gamification.Badge", b =>
                {
            ...
            modelBuilder.Entity("Ermes.Gamification.Medal", b =>
                {
                    b.HasBaseType("Ermes.Gamification.Achievement");
                    ...
                    b.HasDiscriminator().HasValue("Medal");
                });
            ...
            modelBuilder.Entity("Ermes.Alerts.Alert", b =>
                {
                    b.HasOne("Ermes.Alerts.AlertAreaOfInterest", "AlertAreaOfInterest")
                        .WithMany()
                        .HasForeignKey("AlertAreaOfInterestId");
                });

            modelBuilder.Entity("Ermes.Alerts.AlertAreaOfInterest", b =>
                {
                    b.HasOne("Ermes.Alerts.Alert", "Alert")
                        .WithMany()
            ...
            modelBuilder.Entity("Ermes.Communications.CommunicationReceiver", b =>
                {
                    b.HasOne("Ermes.Communications.Communication", "Communication")
                        .WithMany("CommunicationReceivers")
            ...
            modelBuilder.Entity("Ermes.Gamification.Barrier", b =>
                {
                    ...
                    b.HasOne("Ermes.Gamification.Reward", "Reward")
                        .WithOne("Barrier")
            ...
            modelBuilder.Entity("Ermes.Gamification.GamificationAudit", b =>
                {
                    b.HasOne("Ermes.Gamification.GamificationAction", "GamificationAction")
                        .WithMany()
                        .HasForeignKey("GamificationActionId");
            ...
            modelBuilder.Entity("Ermes.Layers.Layer", b =>
                {
                    b.HasOne("Ermes.Layers.Layer", "Parent")
                        .WithMany("AssociatedLayers")
                        .HasForeignKey("ParentDataTypeId")
                        .HasPrincipalKey("DataTypeId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Ermes.MapRequests.MapRequestLayer", b =>
                {
                    b.HasOne("Ermes.Layers.Layer", "Layer")
                        .WithMany("MapRequestLayers")
                        .HasForeignKey("LayerDataTypeId")
                        .HasPrincipalKey("DataTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Ermes.MapRequests.MapRequest", "MapRequest")
                        .WithMany("MapRequestLayers")
                        .HasForeignKey("MapRequestCode")
                        .HasPrincipalKey("Code")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Ermes.Reports.ReportValidation", b =>
                {
                    ...
                    b.HasOne("Ermes.Reports.Report", "Report")
            ...
            modelBuilder.Entity("Ermes.Gamification.Achievement", b =>
                {
                    b.HasOne("Ermes.Gamification.GamificationAction", "GamificationAction")
                        ...
                        .HasForeignKey("GamificationActionCode")
                        .HasPrincipalKey("Code")
                        .OnDelete(DeleteBehavior.Restrict);
                });
