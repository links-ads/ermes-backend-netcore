...
namespace Ermes.Alerts
{
    public class AlertsAppService : ErmesAppServiceBase, IAlertsAppService
    {
        ...
        public AlertsAppService(AlertManager alertManager, IGeoJsonBulkRepository geoJsonBulkRepository, ErmesAppSession ermesAppSession, PersonManager personManager)
        {
            _alertManager = alertManager;
            _geoJsonBulkRepository = geoJsonBulkRepository;
            _session = ermesAppSession;
