...
namespace Ermes.Dashboard
{
    ...
    public class DashboardAppService : ErmesAppServiceBase, IDashboardAppService
    {
        ...
        public virtual async Task<GetStatisticsOutput> GetStatistics(GetStatisticsInput input)
        {
            ...
            var items = _geoJsonBulkRepository.GetPersonActions(start, end, orgIdList, null, null, null, null, _languageManager.CurrentLanguage.Name, orgIdList == null ? CommunicationScopeType.Citizens : CommunicationScopeType.Restricted);
