...
namespace Abp.ErmesSocialNetCore.Model
{
    ...
    public partial class EntityDetails : IEquatable<EntityDetails>, IValidatableObject
    {
        ...
        public EntityDetails(string displayValue = default(string), int end = default(int), Object extra = default(Object), long id = default(long), int labelId = default(int), string labelName = default(string), Object location = default(Object), int start = default(int), string value = default(string))
        {
