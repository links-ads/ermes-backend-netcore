...
namespace Abp.ErmesSocialNetCore.Model
{
    ...
    public partial class Annotation : IEquatable<Annotation>, IValidatableObject
    {
        ...
        public Annotation(PartialAuthor author = default(PartialAuthor), List<ClassificationDetails> classifications = default(List<ClassificationDetails>), DateTime createdAt = default(DateTime), List<EntityDetails> entities = default(List<EntityDetails>), int favoriteCount = default(int), List<string> hashtags = default(List<string>), long id = default(long), bool informative = default(bool), string lang = default(string), Object location = default(Object), List<PartialMedia> media = default(List<PartialMedia>), int quoted = default(int), int retweetCount = default(int), bool retweeted = default(bool), string source = default(string), string text = default(string))
        {
            this.Author = author;
        ...
        public List<ClassificationDetails> Classifications { get; set; }
