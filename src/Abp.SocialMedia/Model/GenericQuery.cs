...
namespace Abp.SocialMedia.Model
{
    ...
    /// GenericQuery
    /// </summary>
    [DataContract(Name = "GenericQuery")]
    public partial class GenericQuery : IEquatable<GenericQuery>, IValidatableObject
    {
        /// <summary>
        /// Defines Languages
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericQuery" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GenericQuery);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GenericQuery input)
        {
            if (input == null)
                return false;
