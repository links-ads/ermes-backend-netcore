...
namespace Ermes.GeoJson
{
    public interface IGeoJsonBulkRepository : IRepository
    {
        ...
        public string GetPersonActions(DateTime StartDate, DateTime EndDate, int[] organizationIdList, List<ActionStatusType> statusTypes, int[] activityIds, Geometry boundingBox, string search = "", string language = "it", CommunicationScopeType scope = CommunicationScopeType.Wide);
